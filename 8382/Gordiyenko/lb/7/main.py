...
if __name__ == '__main__':
    ...
    text = "A brilliant masterpiece with unique style. It starts rather slow, \
            but half time passed it burns the ground. It has everithing you want. \
            Humour, Fantastic style, twisted plot, cool and memorable characters \
            and action."
    text_vec = [text[i] for i in range(len(text)) if i < 500]
    final_pred(model_1,model_2,text_vec)