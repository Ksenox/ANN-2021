...
from tensorflow.keras.layers import Embedding, Conv1D, Dropout, MaxPooling1D, LSTM, Dense
...
custom_x = [
    ...
    "it's very good",
    "it's very bad",
    "fantastic film, wonderful casting, good job, pretty nice",
    "beautiful picture, good scenario, it's obvious"
]
