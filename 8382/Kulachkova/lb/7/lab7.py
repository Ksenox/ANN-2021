...
print(classify_text("example1.txt", all_models, max_review_length, top_words))
print(classify_text("example2.txt", all_models, max_review_length, top_words))
print(classify_text("example3.txt", all_models, max_review_length, top_words))
print(classify_text("example4.txt", all_models, max_review_length, top_words))
