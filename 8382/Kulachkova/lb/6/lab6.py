...
# Загружаем данные
nwords = 10000  # столько уникальных слов будет загружено
...
coded_txt = [read_txt("example1.txt", nwords)]
coded_txt.append(read_txt("example2.txt", nwords))
coded_txt.append(read_txt("example3.txt", nwords))
coded_txt.append(read_txt("example4.txt", nwords))
