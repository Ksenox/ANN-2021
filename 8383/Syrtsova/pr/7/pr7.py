...
plt.plot(range(len(loss)), loss, 'r', label='Train')
plt.plot(range(len(val_loss)), val_loss, 'g', label='Validation')
plt.grid()
...
plt.plot(pred_length, predicted_res, 'r', label='Predicted')
plt.plot(pred_length, test_res, 'g', label='Generated')
plt.title('Sequence')
plt.xlabel('x')
plt.ylabel('Sequence')
plt.grid()
